...
class AboutScreen extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              _buildSectionTitle('Nonchalant University', fontSize: 30, fontWeight: FontWeight.bold),
            ...
            Text(
              ...
              _buildSectionTitle('Mission:', fontSize: 30, fontWeight: FontWeight.bold),
              const SizedBox(height: 0),
              Text(
              ...
              const SizedBox(height: 50),
              _buildSectionTitle('Vision:', fontSize: 30, fontWeight: FontWeight.bold),
              const SizedBox(height: 0),
              Text(
              ...
              const SizedBox(height: 50),
              _buildSectionTitle('History:', fontSize: 30, fontWeight: FontWeight.bold),
              const SizedBox(height: 0),
              Text(
              ...
              const SizedBox(height: 50),
              _buildSectionTitle('Faculty:', fontSize: 30, fontWeight: FontWeight.bold),
              const SizedBox(height: 0),
              Text(
  ...
  Widget _buildSectionTitle(String title, {double? fontSize, FontWeight? fontWeight}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
